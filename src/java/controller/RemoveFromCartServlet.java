...
public class RemoveFromCartServlet extends HttpServlet {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/mpfour?useSSL=false&zeroDateTimeBehavior=CONVERT_TO_NULL";
    private static final String DB_USER = "root";
    private static final String DB_PASS = "passwordsql";
