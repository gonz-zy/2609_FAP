    ...
    <section class="main-container">
        <div class="container">
            ...
            <div class="form-section">
                <h1 class="edit-course-title">Edit Course Details</h1>
                <form method="post" action="/2609_FAP/EditCourseServlet">
                    <input type="hidden" id="course_id" name="course_id" value="<%= request.getParameter("course_id") %>" />

                    <div class="form-group">
                        <label for="courseName">Course Name:</label>
                        <input type="text" id="courseName" name="courseName" maxlength="30" value="<%= request.getParameter("courseName") %>"required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="hours" name="hours" min="1" value="<%= request.getParameter("hours") %>" required />

                    </div>

                    <div class="form-group">
                        <label for="price">Price (₱):</label>
                        <input type="number" id="price" name="price" min="1" max="99999999.99" step="0.01" value="<%= request.getParameter("price") %>" required />
                    </div>
            ...
            <div class="image-section">
                <img src="../images/edit.jpg" id="image1" alt="Edit Illustration" />
